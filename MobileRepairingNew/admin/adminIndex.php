...
<?php
  ...
  if(isset($_POST['functionname'])){
    if($_POST['functionname'] == 'setMod'){
      $_SESSION['modalVal'] = $_POST['arguments'];
    }
  }
                 ...
                 <div class="py-3"><h2 class="text">About Orders</h2></div>
                  ...
                  <?php
                    ...
                    while($row = mysqli_fetch_array($res)){
                      ...
                      <div class="px-4">
                      <a class="link" href="adminIndexMod.php" name = "ord'.$row['ono'].'" onclick=setModal(this)><h4>Order No: '.$row['ono'].'</h4></a>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title">Order Details: <span id="onAc">abc</span></h5>
        ...
        <script>
          function setModal(val){
            ...
            jQuery.ajax({
              ...
              url: 'adminIndex.php',
              dataType: 'json',
              data: {functionname: 'setMod', arguments: val.name.substring(3)},
